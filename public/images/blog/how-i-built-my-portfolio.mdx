...
![The three theme concepts generated from Claude chat: Cyberpunk with dark tones and cyan accents, Minimal Pro with clean bold typography, and the Tropical theme that made the final cut](/images/blog/theme-cyberpunk.png)
![Minimal Pro theme concept](/images/blog/theme-minimal-pro.png)
![Tropical theme concept — the one that shipped](/images/blog/theme-tropical.png)
...
Where it needed guidance: architectural decisions about component boundaries, what should be a Server vs Client Component, and performance-critical choices. AI tools work best when you give them clear direction and let them execute.
...
![Final Lighthouse score — Mobile: 98/100/100/100](/images/blog/lighthouse-after.png)
![Final Lighthouse score — Desktop: 100/100/100/100](/images/blog/lighthouse-desktop.png)
